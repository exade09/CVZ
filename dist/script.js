...
const gameLaunchers = document.querySelectorAll("[data-kvz-open-game]");
...
function loadGameStyles() {
  const existing = document.querySelector("link[data-kvz-game-styles]");
  ...
  return new Promise((resolve, reject) => {
    ...
    link.dataset.kvzGameStyles = "true";
